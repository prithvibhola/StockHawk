...
public class QuoteProvider {
  ...
  interface Path{
    ...
    String QUOTES_GRAPH = "quotes_graph";
  }
  ...
  @TableEndpoint(table = QuoteDatabase.QUOTES_GRAPH)
  public static class QuoteGraph{
    @ContentUri(
            path = Path.QUOTES_GRAPH,
            type = "vnd.android.cursor.dir/quotes_graph"
    )
    public static Uri CONTENT_URI = buildUri(Path.QUOTES_GRAPH);
  }
}
