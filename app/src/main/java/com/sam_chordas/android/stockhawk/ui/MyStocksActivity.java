...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    coordinatorLayout = (CoordinatorLayout) findViewById(R.id.clStock);
    ...
    if (savedInstanceState == null){
      ...
      if (isNetworkAvailable()){
        ...
        Snackbar.make(coordinatorLayout, getResources().getString(R.string.internet_connection),
    ...
    recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
            new RecyclerViewItemClickListener.OnItemClickListener() {
              @Override public void onItemClick(View v, int position) {
                ...
                intent.putExtra(DetailStockActivity.ARG_SYMBOL, c.getString(c.getColumnIndex(QuoteColumns.SYMBOL)));
  ...
  public void onLoadFinished(Loader<Cursor> loader, Cursor data){
    ...
    //Updating the widget when new symbol is added or removed
  ...
  public void fabClick() {
    if (isNetworkAvailable()) {
      new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
              ...
              .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                ...
                public void onInput(MaterialDialog dialog, CharSequence input) {
                  ...
                  if (c.getCount() != 0) {
                    Toast toast = Toast.makeText(MyStocksActivity.this, getResources().getString(R.string.stock_already_saved), Toast.LENGTH_LONG);
      ...
      Snackbar.make(coordinatorLayout, getResources().getString(R.string.internet_connection),
              Snackbar.LENGTH_LONG).setAction(getResources().getString(R.string.try_again), new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          fabClick();
        }
